  ...
  test("POST /posts", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        postUpdatedAt: CREATE_RESULT.postUpdatedAt.toISOString(),
      ...
      .expect([
        {
          ...
          postUpdatedAt: FIND_MANY_RESULT[0].postUpdatedAt.toISOString(),
  ...
  test("GET /posts/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        postUpdatedAt: FIND_ONE_RESULT.postUpdatedAt.toISOString(),
