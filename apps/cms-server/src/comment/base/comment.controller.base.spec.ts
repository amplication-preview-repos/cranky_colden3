...
const CREATE_INPUT = {
  ...
  commentPost: "exampleCommentPost",
  createdAt: new Date(),
  id: "exampleId",
  updatedAt: new Date(),
};
...
describe("Comment", () => {
  ...
  test("POST /comments", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        commentCreatedAt: CREATE_RESULT.commentCreatedAt.toISOString(),
  ...
  test("GET /comments", async () => {
    await request(app.getHttpServer())
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          commentCreatedAt: FIND_MANY_RESULT[0].commentCreatedAt.toISOString(),
  ...
  test("GET /comments/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        commentCreatedAt: FIND_ONE_RESULT.commentCreatedAt.toISOString(),
